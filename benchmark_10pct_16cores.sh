#!/bin/bash
#SBATCH --job-name=matsim_10pct_16cores
...
#SBATCH --exclusive
#SBATCH --output=/home/bada220h/MATSim/matsim-dresden-hpc-benchmark/logs/benchmark_10pct_16cores_%j.out
#SBATCH --error=/home/bada220h/MATSim/matsim-dresden-hpc-benchmark/logs/benchmark_10pct_16cores_%j.err
